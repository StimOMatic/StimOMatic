...
function [succeeded, timeStampArray, eventIDArray, ttlValueArray, eventStringArray, numRecordsReturned, ...
    numRecordsDropped ] = NlxGetNewEventData_optimized(objectName, eventStringArrayPtr)
   ...
   %		disp 'Not Connected'
	...
	%if succeeded == 1
		[succeeded, ~, timeStampArray, eventIDArray, ttlValueArray, eventStringArray, numRecordsReturned, numRecordsDropped ] = calllib('MatlabNetComClient', 'GetNewEventData', objectName, timeStampArrayPtr, eventIDArrayPtr, ttlValueArrayPtr, eventStringArrayPtr, numRecordsReturnedPtr,numRecordsDroppedPtr );
    %end;
