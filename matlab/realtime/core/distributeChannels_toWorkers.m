...
%
%urut/feb12
function [workerChannelMapping, nrWorkers] = distributeChannels_toWorkers( nrWorkersToUseMax, nrActiveChannels, OSortData )
...
if nrActiveChannels <= nrWorkersToUseMax
    ...
    for j=1:nrWorkers
        channelIDReal = str2num(OSortData.CSCChannels{j}.channelStr(4:end));        
...
if nrActiveChannels > nrWorkersToUseMax
   ...
   for channelID = 1:nrActiveChannels 
       channelIDReal = str2num(OSortData.CSCChannels{channelID}.channelStr(4:end));
