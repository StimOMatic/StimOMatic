...
NBR_DATA_POINTS_PER_BUFFER = 512.0
NBR_DATA_POINTS_PER_BUFFER_INT = int(NBR_DATA_POINTS_PER_BUFFER)
SCANRATE = 32556
SECONDS_TO_VISUALIZE_PER_PANEL = 10.0
...
# default X values
X_MIN = 0
X_MAX = float(WIN_WIDTH_DEFAULT) / (NBR_VBOS_PER_PANEL + 1)
# print X_MAX
